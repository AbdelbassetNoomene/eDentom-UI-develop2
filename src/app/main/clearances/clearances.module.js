(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider, API_URL, USER_ROLES)
    {
        ...
        //--fake the Api
        /*msApiProvider.register('clearances', ['app/data/job.:urlSuffix.:jobInstanceId.json', {urlSuffix: '@urlSuffix', jobInstanceId: '@jobInstanceId'}, {
        	getClearances: {method:'GET', params: {urlSuffix: 'clearances',   jobInstanceId: ''}, isArray: true },//<--job.clearances.json
        	isCleared:     {method:'GET', params: {urlSuffix: 'cleared',      jobInstanceId: ''}, isArray: false},//<--job.cleared.9.json
        	update:        {method:'GET', params: {urlSuffix: '',             jobInstanceId: ''}, isArray: false} //<--
        }]);
        msApiProvider.register('statistics', ['app/data/statistics.:urlSuffix.:jobInstanceId.json', {urlSuffix: '@urlSuffix', jobInstanceId: '@jobInstanceId'}, {
        	getStatistics: {method:'GET', params: {urlSuffix: '',             jobInstanceId: ''}, isArray: false}
        }]);*/
