...
gulp.task('build-for-server-url',   ['set-api-url',   'html', 'fonts', 'other']);

gulp.task('build-for-dev-server',   ['set-dev-url',   'html', 'fonts', 'other']);
gulp.task('build-for-test-server',  ['set-test-url',  'html', 'fonts', 'other']);
gulp.task('build-for-live-server',  ['set-live-url',  'html', 'fonts', 'other']);
gulp.task('build-for-local-server', ['set-local-url', 'html', 'fonts', 'other']);
