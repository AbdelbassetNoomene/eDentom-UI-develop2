(function ()
{
    ...
    angular
        .module('edentom')
        .controller('MyStepperController', MyStepperController)
        .directive('myStepper',            myStepperDirective)
        .directive('myStepperStep',        myStepperStepDirective);

    /** @ngInject */
    function MyStepperController($timeout)
    {
        var vm = this;
    ...
    /** @ngInject */
    function myStepperDirective()
    {
        return {
            restrict        : 'A',
            require         : ['form', 'myStepper'],
            priority        : 1001,
            controller      : 'MyStepperController as MyStepper',
            bindToController: {
                model: '=ngModel'
            },
            transclude      : true,
            templateUrl     : 'app/utils/directives/my-stepper/templates/horizontal/horizontal.html',
    ...
    /** @ngInject */
    function myStepperStepDirective()
    {
        return {
            restrict: 'E',
            require : ['form', '^myStepper'],
